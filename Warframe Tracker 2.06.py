# Version 2.06
# - Custom Timers (Tenet, Coda, Baro) are always visible, even when marked complete
# - Completed timers show a ✔ at the end of the label
# - Timers header renamed to "Custom Timers" and matches font boldness/size of other headers
# - Tenet resets start at July 3, 2025, 00:00 UTC, every 4 days
# - Coda resets start at July 5, 2025, 00:00 UTC, every 4 days
...
class TaskTrackerApp:
    ...
    def update_timer_labels(self):
        ...
        tenet_next = next_reset(tenet_base)
        coda_next = next_reset(coda_base)
