# Version 2.09
# - Fix Complete Checked behavior: only marks user-selected checkboxes as complete
# - Separate UI selection state (selection_vars) from completion state (checked_tasks)
# - Tasks hide if completed (checked_tasks=True) and are visible if opted-in (visibility_settings=True)
# - Submenu controls visibility_settings only (opt-in for tasks to show or not)
# - Added comments to clarify state separation and logic
# - Preserves all features from 2.08 exactly
